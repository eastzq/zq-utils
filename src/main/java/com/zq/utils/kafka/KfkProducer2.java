 ...
 *
 */
public class KfkProducer2 {

    private static final Logger logger = LoggerFactory.getLogger(KfkProducer2.class);
     ...
     */
    public KfkProducer2(String bootServers, String topic, String transactionId) {
        this.subject = topic;
     ...
     * @param topic 主题名称。
     */
    public KfkProducer2(String bootServers, String topic) {
